        ...
        <>
            ...
            <div className="h-20 lg:h-30 flex justify-evenly border-t items-center">
                ...
                <div>
                    ...
                    <div className="w-full mt-1 h-0.5 bg-slate-500"></div>
                </div>
                <div>
