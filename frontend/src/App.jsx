...
export default function App() {
    ...
    return (
        <>
            ...
            <div className='w-full p-3 flex justify-end items-end'>
            ...
            <div className="h-20 lg:h-30 flex justify-evenly items-center">
                <div>
