...
export default function MemberManager({ members, loading, queryParams, setQueryParams, pagingInfo }) { // Hapus props setMembers jika belum dipakai
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-visible min-h-125">
                    ...
                    <div className="relative">
                        <form onSubmit={handleSearchSubmit} className="relative w-full md:w-64">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#EE1D52]"
                            />
                        </form>
                        <div className='relative'>
                            <button
            ...
            <div className="p-4 border-t border-slate-100 flex items-center justify-between bg-slate-50/50">
                ...
                <div className="flex items-center gap-2">
                    <button
                        // UBAH DARI pagingInfo.current_page JADI pagingInfo.page
